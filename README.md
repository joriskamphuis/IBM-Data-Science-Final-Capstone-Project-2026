...
Identify factors that influence whether a rocket’s first stage is successfully reused
Build and evaluate predictive models
Translate model results into business‑relevant insights related to rocket reusability and cost reduction
...
Data collection
Use of publicly available rocket launch data

Data cleaning and preprocessing
Handling missing values and formatting variables
...
Feature engineering
Creating variables relevant to reusability outcomes
...
Clear recommendations aligned with rocket reusability and launch cost reduction
...
More detailed engineering or telemetry data
Direct cost modeling
Simulation of reuse strategies over multiple launches
